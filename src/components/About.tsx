        ...
        <div id="about" className="w-full py-16 px-4">
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center">
                    <p className="text-[#7248f0] font-bold">FILLER TEXT</p>
                    <h1 className="md:text-4xl sm:text-3xl text-2xl font-bold py-2">This is all filler text, I will fix it later :D</h1>
                    <p className="">
